...
ActiveRecord::Schema.define(:version => 20120812095036) do

  create_table "header_links", :force => true do |t|
    t.string   "name"
  ...
  add_index "header_links", ["slug"], :name => "index_header_links_on_slug", :unique => true
